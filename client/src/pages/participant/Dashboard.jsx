...
import { getHackathonsApi, getMyRegisteredHackathonsApi } from '../../api/hackathon.api';
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                  {registeredHackathons.length === 0 ? (
                    <p style={{ fontSize: 'var(--hz-font-size-sm)', color: 'var(--hz-text-muted)' }}>You haven't registered for any hackathons yet.</p>
                  ) : (
                    registeredHackathons.map((hackathon) => (
                      <Link to={`/hackathons/${hackathon.id}`} key={hackathon.id} style={{ textDecoration: 'none' }}>
                        <div style={{ display: 'flex', gap: '0.875rem', alignItems: 'flex-start', padding: '0.75rem', borderRadius: '8px', transition: 'background-color 0.2s' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = 'var(--hz-surface-raised)'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}>
                          <div style={{
                            width: '40px',
                            height: '40px',
                            borderRadius: '8px',
                          ...
                          <div>
                            <p style={{ margin: 0, fontSize: 'var(--hz-font-size-sm)', fontWeight: 'var(--hz-font-weight-semibold)', color: 'var(--hz-text)', lineHeight: '1.4' }}>
                              {hackathon.title}
                            </p>
