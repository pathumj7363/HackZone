    ...
    <div className="hz-page" style={{ backgroundColor: '#f8fafc' }}>
      <div className="hz-container">
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          <div>
            <Button onClick={() => navigate('/organizer/hackathon')} variant="primary" style={{ fontWeight: 'bold', padding: '0.75rem 1.5rem', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
