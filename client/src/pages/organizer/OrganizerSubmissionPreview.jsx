      ...
      <div style={containerStyle}>
        ...
        <div style={{ marginBottom: '3rem', background: 'var(--hz-surface)', padding: '2.5rem', borderRadius: '16px', border: '1px solid var(--hz-border)', boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
            ...
            {submission.fileUrl && (
              <a href={getFileUrl(submission.fileUrl, 'download')} target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.9rem', color: 'var(--hz-primary)', textDecoration: 'none', background: 'var(--hz-primary-light)', padding: '0.75rem 1.25rem', borderRadius: '8px', border: '1px solid transparent' }}>
