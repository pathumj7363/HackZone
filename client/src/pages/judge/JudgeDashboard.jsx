...
export default function JudgeDashboard() {
  ...
  return (
    <div className="hz-page hz-container">
      <PageHeader 
        title="Judge Panel" 
        subtitle={`Welcome back, ${user?.name || 'Sarah'}. You have ${pendingCount} evaluations remaining for today's track.`}
      />
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
        <Card padding style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <h2 className="hz-heading-2">{pendingCount}</h2>
          </div>
        ...
        <Card padding style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <h2 className="hz-heading-2">{completedCount}</h2>
          </div>
        ...
        <Card padding style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <h2 className="hz-heading-2">{avgTime}</h2>
          </div>
